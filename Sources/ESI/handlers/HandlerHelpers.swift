...
extension Handlers {
	...
	static func appExtras(_ request: HTTPRequest) -> [String : Any] {
		...
		return [
			...
			"configEmailText": configEmailText,
			"configAutoMonth": configAutoMonth,
			"configDayOfMonth": configDayOfMonth,
			"configRandomOrder": configRandomOrder
		]
	...
	static func redirectRequest(_ request: HTTPRequest, _ response: HTTPResponse, msg: String, template: String, additional: [String:Any] = [String:Any]()) {
